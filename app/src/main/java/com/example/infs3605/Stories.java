...
public class Stories {
    ...
    public Stories(String id, String title, String story, String url, int img) {
        this.id = id;
        this.title = title;
        this.story = story;
        this.url = url;
    ...
    public static ArrayList<Stories> getStories() {
        ...
        stories.add(new Stories("1", "Tiddalik The Frog",
                ...
                "https://www.youtube.com/watch?v=0y3Ta5xcKV4&ab_channel=RedPixelsAnimation", R.drawable.poster1));
        stories.add(new Stories("2", "The Rainbow Serpent", "At the beginning of the Dreamtime, the earth was flat and dry and empty. There were no trees, no rivers, no animals and no grass. It was a dry and flat land.\n" +
                "\n" +
                ...
                "\n" +
                "Now, every time, just after it rains, you can see the Rainbow Serpent sharing his beautiful colours with the people on the ground as his way of saying sorry for taking those Rainbow Lorikeet brothers.", "https://www.youtube.com/watch?v=pCuuRRrfOXo&ab_channel=notrebrut", R.drawable.poster2));
        stories.add(new Stories("3", "Why Koala Has A Stumpy Tail", "Long, long ago in the Dreamtime, there lived Koala and Tree Kangaroo. They were the very best of friends. Back then, Koala had a very long, furry tail just like his friend, Tree Kangaroo. \n" +
                "\n" +
                "One year, there was no rain. All of the streams, rivers and lakes were dried up and no water was found anywhere. Even the leaves in the trees were dying. Koala said, “What are we going to do? We are going to die if we don’t get some water to drink.” \n" +
                "\n" +
                "Just then, Tree Kangaroo had a plan. He remembered back to the last dry season when his mother dug a hole in a dry stream bed. “She dug for hours until water began to fill the bottom of the dry hole,” said Tree Kangaroo. “Let’s try that!” said Koala." +
                "\n" +
                "So Tree Kangaroo and Koala walked until they came to a dry stream bed. It was as dry as the desert. \n" +
                "\n" +
                "Koala said, “I am so thirsty and tired. Before I can start digging, I need to have a rest.” So Koala climbed up the closest tree, and left Tree Kangaroo to start digging for the water. \n" +
                "\n" +
                "After lots of digging, Tree Kangaroo called out to Koala, “Hey Koala, come and help me dig!” Koala began to climb down from the tree until he let out a big, “Ouch!” \n" +
                "\n" +
                "Koala had got a thorn in his foot. He couldn’t possibly dig with a sore foot, so Tree Kangaroo kept on digging and let Koala rest. \n" +
                "\n" +
                "Tree Kangaroo was getting really tired after all of his digging. “Koala!” he yelled, “I am so tired and I need a break. It is your turn to come and dig.” Koala began to climb down the tree until he called out, “I am so dizzy. I need to rest longer.” Tree Kangaroo was starting to get very angry, but he kept on digging. \n" +
                "\n" +
                "At last, some water began to appear in the dry hole. “Hooray, I can see water,” yelled Tree Kangaroo. Koala heard this and he quickly jumped from the tree. \n" +
                "\n" +
                "He pushed Tree Kangaroo out of the way, stuck his head down the hole and began drinking all of the water. Tree Kangaroo was furious! “Save some for me,” he said, but Koala just kept on drinking. \n" +
                "\n" +
                "Tree Kangaroo grabbed Koala’s tail to pull him out of the hole. He pulled and pulled until … \n" +
                "\n" +
                "Koala’s tail broke off. This is why the koala has a short and stumpy tail.", "https://www.youtube.com/watch?v=itszep0duwI&ab_channel=AugustHouse%2FStoryCove", R.drawable.poster3));
        stories.add(new Stories("4", "How the Kangaroo got its pouch", "Long ago the kangaroo was grooming her joey on the bank of a brook. They liked to listen to the water burble as the mama combed her baby’s fur. On this day, an old wombat staggered toward them.\n" +
                "\n" +
                ...
                "\n" +
                "Byamee loved the kangaroo’s generous heart. So he decided to make pouches for all the other marsupial mothers. Ever since then, their babies almost never get lost.", "https://www.youtube.com/watch?v=8sWFAGGWvUA&ab_channel=StormandAllie", R.drawable.poster4));
        stories.add(new Stories("5", "Biladurang the Platypus", "When the old people sat around their campfire, they would tell the dreamtime story of the platypus.\n" +
                "\n" +
        ...
        stories.add(new Stories("6", "Mirram the Kangaroo and Warreen the Wombat", "Many years ago, Mirram the kangaroo and Warreen the wombat were both men. They were very friendly, and hunted and lived together in the same camping-ground. Warreen had a very comfortable gunyah made of bark and soft leaves, but Mirram who was a careless fellow-did not trouble to build a home. He was content to sleep in the open, by the side of a big fire, with the blue sky for a cover, and the green grass for a couch. This open air life was very nice in fine weather, when the stars twinkled in the sky like golden fire-flies, but it was extremely uncomfortable in the rainy season.\n" +
                ...
                "\n" +
                "From that time the kangaroo has had a long tail, which makes a low, thudding sound as he wanders homeless through the bush, and the wombat still has a very flat forehead as an everlasting sign of selfishness.", "https://www.youtube.com/watch?v=xDJrnldb08o&ab_channel=RedPixelsAnimation", R.drawable.poster6));
        stories.add(new Stories("7", "Wayambeh the Turtle", "A long time ago, there lived a man named Wayambeh who was very stubborn and did not listen to his Elders. Every day he did what he wanted to do and did not obey any of the tribal rules. \n" +
                "\n" +
                "One day, the Elders told Wayambeh that It was time for him to marry a woman from his tribe, but Wayambeh refused the woman who was selected for him. Instead, he grabbed his spear and marched off into the bush to hunt.\n" +
                "\n" +
                "While Wayambeh was hunting, he wrongfully entered another tribe's territory - this tribe was known as the Spiny Lizards. He saw a woman from the Spiny Lizards who was digging for yams with a digging stick. He decided that she was the woman who he wanted to marry.\n" +
                "\n" +
                "Wayambeh crept up on the woman like a snake and snatched her from where she was digging. The woman's name was Ula - she was the princess of the Spiny Lizards. Ula explained to Wayambeh that she was already married with a baby and that she could not marry him because she belonged to the Spiny Lizards. \n" +
                "\n" +
                "Wayambeh, however, did not listen to Ula, in the same way that he did not listen to his Elders. Instead, he stole Ula from her tribe and returned to his tribe with her. \n" +
                "\n" +
                "The Elders were very cross - when they saw Wayambeh with Ula, \"You must return Ula to her tribe immediately,\" they demanded. But Wayambeh was again disrespectful and disobedient - he did not return Ula. \n" +
                "\n" +
                "The Elders warned Wayambeh that the Spiny Lizards would come to take Ula back, and the Elders cautioned Wayambeh that they would not support him in this battle against the Spiny Lizards. \"If you insist on being so headstrong, you will fight this battle on your own,\" exclaimed the Elders sternly. \n" +
                "\n" +
                "Soon enough the Spiny Lizards arrived one by one to take Ula back to her territory and her rightful tribe. When Wayambeh spotted the Spiny Lizards, he rapidly armed himself by wrapping his shields around his front and his back. Once armed, he taunted the Spiny Lizards and they retaliated by throwing a cloud of spears at Wayambeh. Suddenly fearing for his life and regretting that he had selfishly taken Ula and broken tribal laws, Wayambeh jumped into a nearby billabong and was never seen again as a man.\n" +
                "\n" +
                "Several days later, a strange creature with a long neck appeared from the billabong into which Wayambeh had dove, and showed itself before the tribe. It had a hard shell covering its back and belly. The tribe crowded around the creature and realised it was Wayambeh. He had been transformed into the first long-necked turtle - the billabong was now his home.", "https://www.youtube.com/watch?v=DpzDvpZ0hMg&ab_channel=RedPixelsAnimation", R.drawable.poster7));
        stories.add(new Stories("8", "Moon Creation Story", "Brolly Bird, the crane, loved to dance.\n" +
                ...
                "She danced under the moon to thank her for her help.", "https://www.youtube.com/watch?v=C9BBZz9qSvE&ab_channel=StormandAllie", R.drawable.poster8));
        stories.add(new Stories("9", "How the Birds got their Colours", "Long, long ago in the Dreamtime, all the birds were black in colour. They did not have any bright or fancy colours on their feathers.\n" +
                "\n" +
                "One day, a little bird was flying around, looking for food. The little bird flew down to catch a big, juicy and delicious looking grub. When the bird flew down to the ground, it hurt itself on a big, sharp stick. It cut deep into his foot and made him very, very sick.\n" +
                "\n" +
                "For days, the little bird had a swollen foot and was in so much pain. He was dying! All of the little bird’s friends came to see if they could help. They all wanted to save the little bird, except for one bird… the crow.\n" +
                "\n" +
                "Suddenly, a parrot rushed towards the sick little bird and burst its swollen foot with its beak. Different colours rushed out and splashed all over the parrot. There were reds, greens, blues, yellows and other colours of the rainbow. All of the wonderful bright colours ran down her chest, wings and tail. The colours also splashed out onto the other birds. Some were red, some were blue, some were brown and some were yellow. Some birds were lucky and even got spots and stripes too.\n" +
                "\n" +
                "All of the birds were happy and excited, except for crow, who was standing far away from them all. Crow didn’t get any colours at all. The sick little bird soon became better. He thanked the parrot for helping him with his swollen foot and then flew away.\n" +
                "\n" +
                "And that’s how the birds got their colours.", "https://www.youtube.com/watch?v=JtRHtCa6GZ8&ab_channel=DaveEdgren", R.drawable.poster9));
        stories.add(new Stories("10", "Murray River Creation Story", "In the Dreaming, Ngurunderi travelled down the Murray River in a bark canoe, in search of his two wives who had run away from him. At that time the river was only a small stream, below the junction with the Darling River.\n" +
                "\n" +
                ...
                "\n" +
                "Ngurunderi knew that it was time for him to enter the spirit world. He crossed to Kangaroo Island and travelled to its western end. After first throwing his spears into the sea, he dived in, before rising to become a star in the Milky Way.", "https://www.youtube.com/watch?v=TgjY27Sy48g&ab_channel=AboriginalDreamtime%26Stories", R.drawable.poster10));
        return stories;
    }
